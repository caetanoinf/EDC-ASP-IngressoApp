...
{
    /// <inheritdoc />
    public partial class CargaInicialIngresso : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            var context = new AppDbContext();
            context.Ingresso.AddRange(ObterCargaInicial(context));
            context.SaveChanges();
        }

        private IList<Ingresso> ObterCargaInicial(AppDbContext context)
        {
            return new List<Ingresso>()
            {
                new()
                {
                    ...
                    Descricao =
                        "Prepare-se para uma noite cheia de risadas e diversão no vibrante show de comédia ao vivo com Laura Mendes. Com seu humor inteligente e carisma cativante, Laura vai garantir uma experiência memorável para todos. Não perca este espetáculo imperdível!",
                ...
                new()
                {
                    ...
                    Descricao =
                        "Deixe-se envolver pela energia positiva e pelos ritmos contagiante do show de reggae ao vivo com The Groove Explorers. Uma noite repleta de boa música, vibes positivas e momentos inesquecíveis aguardam por você. Venha fazer parte deste espetáculo único!",
                ...
                new()
                {
                    ...
                    Descricao =
                        "Experimente uma noite de inspiração e espiritualidade no show gospel ao vivo com Voices of Faith. Com poderosas vozes e mensagens tocantes, este evento promete elevar sua alma e proporcionar momentos de reflexão profunda. Não perca essa experiência única!",
